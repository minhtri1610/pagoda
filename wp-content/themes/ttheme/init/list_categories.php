<?php
    ...
    function quan_ly_cau_doi()
    {
        /*
        * Biến $label để chứa các text liên quan đến tên hiển thị của Post Type trong Admin
        */
        $label = array(
            'name' => 'Quản lý câu đối', //Tên post type dạng số nhiều
            'singular_name' => 'Quản lý câu đối' //
        );
        ...
        */
        $args = array(
            ...
            'show_in_nav_menus' => true, //Hiển thị trong Appearance -> Menus
            'show_in_admin_bar' => true, //Hiển thị trên thanh Admin bar màu đen.
            'menu_position' => 8, //Thứ tự vị trí hiển thị trong menu (tay trái)
            'menu_icon' => 'dashicons-editor-paste-word', //Đường dẫn tới icon sẽ hiển thị
            'can_export' => true, //Có thể export nội dung bằng Tools -> Export
            'has_archive' => true, //Cho phép lưu trữ (month, date, year)
            'exclude_from_search' => false, //Loại bỏ khỏi kết quả tìm kiếm
        ...
        register_post_type('caudoi', $args); //Tạo post type với slug tên là sanpham và các tham số trong biến $args ở trên
    
    }
    add_action('init', 'quan_ly_cau_doi');
?>